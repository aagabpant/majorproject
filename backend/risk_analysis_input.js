...
// Function to execute and handle the risk_analysis_input request
export default function executeRiskAnalysisInput(requestParams) {
  const {
    quarters,
    banks,
    filepath,
  ...
  const functionname = "risk_analysis_input";
  ...
  if (pythonProcess.error) {
    ...
    try {
      ...
      const resultFilePath = `C:/Users/Aagab/PycharmProjects/pythonProject1/${access_token}/z output/risk_analysis_input.json`;
