...
export default function executeQuarterFromInput(requestParams) {
  const {
    quarters,
    banks,
    filepath,
  ...
  const functionname = "quarter_extraction_from_newfile";
  ...
  if (pythonProcess.error) {
    ...
    try {
      ...
      const resultFilePath = `C:/Users/Aagab/PycharmProjects/pythonProject1/${access_token}/z output/quarter_from_input.json`;
