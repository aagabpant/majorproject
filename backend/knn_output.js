...
export default function executeKnnOutput(requestParams) {
  const {
    quarters,
    banks,
    filepath,
  ...
  if (pythonProcess.error) {
    ...
    try {
      ...
      const resultFilePath = `C:/Users/Aagab/PycharmProjects/pythonProject1/${access_token}/z output/knn_output.json`;
